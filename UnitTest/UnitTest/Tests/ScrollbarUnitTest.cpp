...
TESTCASE(ScrollBarShould, HaveSamePositionWhenCreated) {
	// Arrange
...
TESTCASE(ScrollBarShould, HaveCorrectCenterPosition) {
	// Arrange
...
TESTCASE(ScrollBarShould, IsDefaultVisible) {
	// Arrange
	bool expected = true;
	bool actual;
	auto btn = Gui::ScrollBar({ 0, 0 }, { 100, 100 }, { 50, 50 }, { 0, 0 });
...
TESTCASE(ScrollBarShould, SizeIsActual) {
	// Arrange
